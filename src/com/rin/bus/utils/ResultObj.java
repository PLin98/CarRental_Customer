...
public class ResultObj {
	 ...
	 * 预定成功
	 */
	public static final ResultObj RENTING_SUCCESS=new ResultObj(SysConstast.CODE_SUCCESS, SysConstast.RENTING_SUCCESS); 
	/**
	 * 预定失败
	 */
	public static final ResultObj RENTING_ERROR=new ResultObj(SysConstast.CODE_ERROR, SysConstast.RENTING_ERROR); 
	/**
	 * 添加成功
	 */
