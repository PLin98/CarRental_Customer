	    ...
	    layui.use([ 'jquery', 'layer', 'form', 'table','laydate'  ], function() {
			...
			//渲染数据表格
			 tableIns=table.render({
			    ...
			    ,url:'${rincar}/rent/loadAllRent.action?identity=${customer.identity}' //数据接口
			    ...
			    ,cols: [[   //列表数据
			      ...
			      ,{fixed: 'right', title:'操作', toolbar: '#rentBar', width:'80',align:'center'}
			    ]],
			...
			$("#doSearch").click(function(){
				...
				tableIns.reload({
					url:"${rincar}/rent/loadAllRent.action?identity=${customer.identity}&"+params,
				    page:{
				    	curr:1
				    }
				})
